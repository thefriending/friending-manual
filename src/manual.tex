...
\appscreenshot{\fileStart}{Start}{fig:start}
...
\appscreenshot{\fileOnboarding}{Onboarding}{fig:onboarding}
...
\appscreenshot{\fileHomepageEmpty}{The first run home page}{fig:homestart}
...
\appscreenshot{\fileNavigation}{Navigation Menu}{fig:navigation}
...
\appscreenshot{\fileSignup}{Sign Up}{fig:signup}
...
\appscreenshot{\fileSignin}{Sign In}{fig:signin}
...
\appscreenshot{\fileSettings}{Settings}{fig:settings}
...
\appscreenshot{\fileReset}{Reset your password}{fig:reset}
...
\appscreenshot{\fileBilling}{Billing}{fig:billing}
...
\appscreenshot{\fileCredit}{Credit Information}{fig:credit}
...
\appscreenshot{\fileBillingNotification}{Billing Notifcation}{fig:billingnotify}
...
\appscreenshot{\fileProfile}{Profile}{fig:profile}
...
\appscreenshot{\filePreferences}{Preferences}{fig:preferences}
...
\section{Groups}
\label{sec:groups}
\appscreenshot{\fileFill}{Group Questionnaire}{fig:fill}
\appscreenshot{\fileFilling}{Group Questionnaire Answering}{fig:filling}
\appscreenshot{\fileGroupEdit}{Group Editting}{fig:groupedit}
\appscreenshot{\fileGroupJoin}{Group Join}{fig:groupjoin}
\appscreenshot{\fileGroup}{Group View}{fig:group}
\appscreenshot{\fileGroups}{Groups}{fig:groups}
\appscreenshot{\fileAnswer}{Submitted Questionnaire}{fig:answer}
\appscreenshot{\fileAnswers}{Questionnaire Answers}{fig:answers}
...
\section{Events}
\label{sec:events}
\appscreenshot{\fileEventEdit}{Event Edit}{fig:eventedit}
\appscreenshot{\fileEventQuestionnaire}{Event Fill}{fig:eventfill}
\appscreenshot{\fileEventEntered}{Event Filled In}{fig:eventfilled}
\appscreenshot{\fileEventEntry}{Event Filling}{fig:eventfilling}
\appscreenshot{\fileEventJoined}{Event Joined}{fig:eventjoined}
\appscreenshot{\fileEvent}{Event}{fig:event}
\appscreenshot{\fileEvents}{Events}{fig:events}
...
To leave a group, \action{tap} on the community that you wish to leave on \Screenshot{Home} (Figure~\ref{fig:home}). This opens the \Screenshot{Group Details} (Figure~\ref{fig:group}).  Then, while on \Screenshot{Group Details}, \action{tap} on the \keys{Leave} button.  The group will be removed from your \Screenshot{Home} (Figure~\ref{fig:home}).  If you wish to re-join the group, see section \ref{sec:groups-join}.

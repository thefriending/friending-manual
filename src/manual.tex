...
To host a event, \action{tap} on the \keys{Create Party} button on the \Screenshot{Home} (Figure~\ref{fig:home}). This opens the \Screenshot{Event Create} (Figure~\ref{fig:eventedit}). 
